...
public class PracticalTest02MainActivity extends AppCompatActivity {
    ...
    private EditText alarmEditText = null;
    ...
    private class GetWeatherForecastButtonClickListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (alarm == null || alarm.isEmpty()
                ...
                Toast.makeText(getApplicationContext(), "[MAIN ACTIVITY] Parameters from client (minutes / information type) should be filled", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            clientThread = new ClientThread(
                    clientAddress, Integer.parseInt(clientPort), alarm, informationType, weatherForecastTextView
            );
            clientThread.start();
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alarmEditText = (EditText)findViewById(R.id.alarm_edit_text);

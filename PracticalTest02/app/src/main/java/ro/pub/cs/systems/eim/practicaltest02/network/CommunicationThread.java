...
//                    HttpGet httpGet = new HttpGet(Constants.WEB_SERVICE_ADDRESS + "?q=" + city + "&APPID=" + Constants.WEB_SERVICE_API_KEY + "&units=" + Constants.UNITS);
            ...
            switch(informationType) {
                ...
                case Constants.MINUTES:
                    result = alarmInformation.getMinutes();
                    break;
                case Constants.HOURS:
                    result = alarmInformation.getHours();
                    break;
                case Constants.POLL:
                    result = alarmInformation.getAlarm();
                    break;
                case Constants.RESET:
                    alarmInformation.reset();
                    break;
                case Constants.SET:
                    alarmInformation.setAlarm(alarm);
                    break;
                default:
